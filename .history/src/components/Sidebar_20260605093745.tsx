      ...
      <div>
        ...
        <div className="h-16 flex items-center px-6 border-b border-zinc-800/40">
          <div className="flex items-center space-x-3">
            ...
            <div className="w-8 h-8 rounded-lg bg-gradient-to-tr from-indigo-600 via-purple-600 to-pink-500 flex items-center justify-center shadow-lg shadow-purple-500/20">
              <span className="font-display font-bold text-white text-base tracking-wider">IF</span>
            </div>
            <div>
              <span className="font-display font-semibold text-white tracking-tight text-lg">IdeaFlow</span>
