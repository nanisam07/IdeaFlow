...
export default function LandingPage({ onEnterApp, onGoToLogin, onSelectPlan }: LANDING_PAGE_PROPS) {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      author: "Hideo Kojima",
      role: "Director of Systems, Kojipro",
      initials: "HK",
      ...
      <header className="sticky top-0 z-50 h-16 bg-stone-950/80 backdrop-blur-md border-b border-zinc-900/60 transition-all">
        <div className="max-w-7xl mx-auto h-full px-6 flex items-center justify-between">
          <div className="flex items-center space-x-3 select-none">
            <div className="w-9 h-9 rounded-xl bg-gradient-to-tr from-indigo-650 via-purple-650 to-pink-500 flex items-center justify-center shadow-lg shadow-purple-500/15">
              <span className="font-display font-black text-white text-base tracking-wider">IF</span>
            </div>
            <div>
              <span className="font-display font-bold text-white tracking-tight text-lg">IdeaFlow</span>
          ...
          <nav className="hidden md:flex items-center space-x-8 text-sm font-medium text-zinc-400">
            ...
            <a href="#developer" className="hover:text-white transition-colors font-mono text-zinc-500 text-xs">DEVELOPED BY IDEA2SITE</a>
          </nav>
      ...
      <footer className="border-t border-zinc-900 py-12 bg-neutral-950 relative z-10 selection:bg-slate-800">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="text-zinc-500 text-xs font-medium">
            Designed & Developed by <a href="#developer" className="text-zinc-400 hover:text-white transition">Idea2Site</a>
          </div>

          <div className="flex space-x-6 text-xs text-zinc-500 font-mono">
            <span>PLATFORM VER: 2026.04</span>
